...
class Player
    ...
    def initialize
        ...
        @actions = [RestAction.new(REST_HP), RangedAttackAction.new, MeleeAttackAction.new, RescueAction.new, PivotAction.new, WalkAction.new] # Order inside array indicates priority
    end
